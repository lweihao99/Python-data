    ...
    for line in fd:
        ...
        if tipo == 'pubblicazione':
            ...
            li.append((tipo, data, idAnnuncio,
                       idAbitazione, m2, prezzoM2Proposto))
        elif tipo == 'rimozione':
            # Data;tipoOperazione(rimozione);idAnnuncio
            data = fields[0]
            idAnnuncio = int(fields[2])
            ...
            li.append((tipo, data, idProprietario,
                       idAbitazione, m2, prezzoM2Vendita))
    return li
...
def giornoAnno(dataPar):  # '2010_07_12'
    ...
    for mese in ['gennaio', 'febbraio', 'marzo', 'aprile', 'maggio', 'giugno', 'luglio', 'agosto', 'settembre', 'ottobre', 'novembre']:  # dicembre non serve
        ...
        ggMesePrec[ii] = prog
        ii += 1
    # i mesi sono numerati da 1 a 12, gli indici della lista da 0 a 11
    return gg+ggMesePrec[mm-1]
...
def calcolaDurataAnnuncio(ds):
    ...
    for el in ds:
        ...
        if tipo == 'pubblicazione':
            ...
            data = el[1]
            idAnnuncio = el[2]
            #  a questo punto si sarebbe potuto calcolare direttamente diG ed evitare il ciclo for successivo
            diRim[idAnnuncio] = giornoAnno(data)
...
def prezziCategorieAbitazioni(ds):
    ...
    for el in ds:
        ...
        if tipo == 'catasto':
            ...
            diDen[cat] += m2
    for k in diNum:
        #  il float() sarebbe necessario solo in python2
        diMed[k] = float(diNum[k]) / diDen[k]
    return diMed
