...
#   Il primo elemento di ogni tupla permette di distinguere il tipo riga letto.
...
#   }
#   dove alla chiave 'aumenti' deve essere associata una lista contenente gli identificatori
#   degli appartamenti (idAp) in cui il prezzo di vendita è risultato maggiore del prezzo iniziale
#   (cioè il prezzo al momento della pubblicazione dell'annuncio).
#   Alla chiave 'diminuzioni' deve essere invece associata una lista con gli idAp degli appartamenti
